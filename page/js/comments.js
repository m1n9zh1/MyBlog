var comments = new Vue({
    ...
    methods: {
        ...
        addComment: function () {
            ...
            this.submit = '提交评论中···'
            axios({
                url: '/insertComment?blogId=' + -1 + '&parent=' + parent + '&username=' + username + '&email=' + email + '&content=' + content,
                method: 'get'
            }).then(function (resp) {
                that.getComment(-1, that.curNum, that.commentSize);
                setTimeout(function () {
                    that.flag = false;
        ...
        getComment : function (blogId, current, size) {
            ...
            axios({
                ...
                that.count = parentComment.length;
                that.submit = '提交成功';
                that.getTurnPage();
    ...
    created: function () {
        this.getCookies();
        this.getComment(-1 , this.curNum, this.commentSize);
        this.getRandomCode();
    }
})